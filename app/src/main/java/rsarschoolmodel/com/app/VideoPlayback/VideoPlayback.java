...
import rsarschoolmodel.com.SampleApplication.SampleApplicationControl;
import rsarschoolmodel.com.SampleApplication.SampleApplicationException;
import rsarschoolmodel.com.SampleApplication.SampleApplicationSession;
import rsarschoolmodel.com.SampleApplication.utils.LoadingDialogHandler;
import rsarschoolmodel.com.SampleApplication.utils.SampleApplicationGLView;
import rsarschoolmodel.com.SampleApplication.utils.Texture;
import rsarschoolmodel.com.dynamics.ChapterModel;
import rsarschoolmodel.com.rsarschoolmodel.ImageModel;
import rsarschoolmodel.com.rsarschoolmodel.R;
import rsarschoolmodel.com.rsarschoolmodel.SlidingImage_Adapter;
import rsarschoolmodel.com.ui.SampleAppMenu.SampleAppMenu;
import rsarschoolmodel.com.ui.SampleAppMenu.SampleAppMenuGroup;
import rsarschoolmodel.com.ui.SampleAppMenu.SampleAppMenuInterface;
        ...
        SampleApplicationControl, SampleAppMenuInterface
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        for ( i = 0; i < NUM_TARGETS; i++)
        {
            ...
            mMovieName[i] = ".RSARSchoolModel/"+Pref_School_Fb_Name+"/"+model.getClass_Name()+"/"+model.getSubject_Name()+"/"+model.getBook_Name()
    ...
    public boolean doLoadTrackersData()
    {
       ...
       /* if (!dataSetStonesAndChips.load("StonesAndChips.xml",
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            ...
            file = new File(dir, "/.RSARSchoolModel/"+Pref_School_Fb_Name+"/"+Class_Name+"/"+Sub_Name+"/"+Book_Name+"/"+"DataSet"+"/"+DataSet_Name+"/"+DataSet_Name+".xml" );
        }else{
