                    ...
                    try
                    {
                      ...
                      /*  AssetFileDescriptor afd = mParentActivityRef.get().getAssets()
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                            //File SDCardRoot1 = new File(Environment.getExternalStorageDirectory() + File.separator + "");
                            // File SDCardRoot1=Context.getExternalStorageDirectory(Environment.DIRECTORY_DOCUMENTS);
                            ///storage/emulated/0/Android/data/rsarapp.com.rsarapp/files/Documents/"
                            File SDCardRoot1= new File("/storage/emulated/0/Android/data/rsarschoolmodel.com.rsarschoolmodel/files/Documents");
                            //SDCardRoot = Environment.getExternalStorageDirectory()+"/Android/data/rsarapp.com.rsarapp/files/Documents/";
                            Log.d("Archeck2=",""+SDCardRoot1);
                            File file = new File(SDCardRoot1,filename);
                            Log.d("Archeck4=",""+SDCardRoot1);
                            FileInputStream fileInputStream = new FileInputStream(file);
                            mMediaPlayer.setDataSource(fileInputStream.getFD());
                            fileInputStream.close();
                        }else{
                            SDCardRoot = Environment.getExternalStorageDirectory();
                            Log.d("Archeck3=",""+SDCardRoot);
                            File file = new File(SDCardRoot,filename);
                            Log.d("Archeck4=",""+SDCardRoot);
                            FileInputStream fileInputStream = new FileInputStream(file);
                            mMediaPlayer.setDataSource(fileInputStream.getFD());
                            fileInputStream.close();
                        }
