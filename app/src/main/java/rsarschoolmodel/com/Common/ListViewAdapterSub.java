  ...
  /*  File ebook_directory;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
          ...
          unzipLocation = Environment.getExternalStorageDirectory() +"/.RSARSchoolModel"+"/"+Str_Class_Name+"/"+Str_Sub_Name+"/"+
                  Str_Book_Name;
    ...
    private class UnZipTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            File filev = new File(Environment.getExternalStorageDirectory(), zip_Name+".zip");
