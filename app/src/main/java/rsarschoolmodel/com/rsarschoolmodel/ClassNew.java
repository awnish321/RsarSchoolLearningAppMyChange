...
public class ClassNew extends AppCompatActivity {
    ...
    LinearLayout ln_logo_bg, ln_bottom_bg, ln_top_bg,llBackgroundDesign,llBackgroundDesign1;
    ImageView Img_Sch_Logo,imgLogout;
    ...
    String Pref_Bg_Code, Pref_Top_Bg_Code, Pref_Button_Bg, Pref_School_UI, Pref_School_name, Pref_Fd_School_name,
            Pref_Class_List, Pref_Restric_Id, Pref_Sch_Name_Color, Str_Notify_Msg_Link, Pref_Email, Pref_Mob;
    ...
    ImageView imageViewlog,refresh,Img_School_logo_bg;
    TextView ty1, ty2, ty3,txtTittle;
    boolean vishu = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.R){
            schoollogo= new  File(context.getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS)+"/.RSARSchoolModel"+"/"+Pref_Fd_School_name+"/images/"+"school_logo.png");
            logobg= new  File(context.getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS)+"/.RSARSchoolModel"+"/"+Pref_Fd_School_name+"/images/"+"logo_bg.png");
        }
        else{
            schoollogo= new  File(Environment.getExternalStorageDirectory()+Pref_Fd_School_name+"/images/"+"school_logo.png");
...
//        });
        ...
        if(Str_Otp_Value.equalsIgnoreCase("True"))
        {
            ...
            refresh.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    OtpRefresh();
                    Toast.makeText(ClassNew.this, "Refreshing....Wait", Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private void Call_Button()  {
        Img_School_logo_bg = (ImageView)findViewById(R.id.Img_School_logo_bg);
        Img_Sch_Logo=(ImageView)findViewById(R.id.Img_School_logo);
        ln_bottom_bg = (LinearLayout)findViewById(R.id.Ln_Bottom_Bg);
        ln_top_bg = (LinearLayout)findViewById(R.id.llView);
        ...
        ln_bottom_bg.setBackgroundColor(Color.parseColor(Pref_Bg_Code));
        ...
        Img_School_logo_bg.setBackgroundDrawable(background);
        try {
                        ...
                        for (int i = 0; i < array.length(); i++) {
                            ...
                            if(Str_Status.equalsIgnoreCase("True"))
                            {
                                ...
                                for(int j=0; j<Class_Data.length(); j++)
                                {
                                    ...
                                    String SQLiteDataBaseQueryHolder = "INSERT INTO "+ DBHandlerClass.TABLE_NAME+"" + " (Str_Class_Name,Str_Class_Id) VALUES('"+ClassName+"', '"+ClassId+"')";
